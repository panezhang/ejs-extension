...
var LayoutLoader = require(path.join(__dirname, 'LayoutLoader.class'));
var WidgetLoader = require(path.join(__dirname, 'WidgetLoader.class'));
var ScriptLoader = require(path.join(__dirname, 'ScriptLoader.class'));
var StyleLoader = require(path.join(__dirname, 'StyleLoader.class'));
        ...
        render: function (res, options, callback) {
            ...
            res.render(this.pageRenderID, {data: opts}, function (err, html) {
                ...
                if (html) {
                    ...
                    var nestedScriptHtml = scriptLoader.outputNestedScripts(html);
